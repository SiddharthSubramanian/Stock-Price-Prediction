...
os.chdir('C:\\Users\\Kaushik\\Desktop\\StockMarket')
...
timestamp_list, close_list, high_list, low_list, open_price_list, volume_list
...
np.savetxt("foo.csv", feature4, delimiter=",")
...
np.savetxt("test_label4.csv", test_label4, delimiter=",")
np.savetxt("train_label4.csv", train_label4, delimiter=",")
np.savetxt("train_feature4.csv", train_feature4, delimiter=",")
np.savetxt("test_feature4.csv", test_feature4,delimiter=",")
...
np.savetxt("input_pred.csv",testdata_label)
...
n_timesteps = 5
out1 = input_reshape(n_timesteps, train_feature4)
